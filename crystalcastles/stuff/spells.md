...
Here’s an updated version of 10 spells for your RPG, with each spell following the format you provided. Each has its own Misfire, Light, and Heavy tables to reflect the power level and unpredictability.
...
1.  The caster becomes confused, forgetting what they were doing.
2.  The target is immune to all mental effects for 1 hour.
3.  The caster is overwhelmed with fear, fleeing for 1 turn.

**Light Effect Table**:

1.  Target is disoriented, gaining disadvantage on their next action.
2.  Target suffers brief confusion, acting randomly for 1 turn.
3.  Target is filled with irrational fear, retreating or avoiding the caster.

**Heavy Effect Table**:

1.  The target falls unconscious for 1 turn, mind temporarily overwhelmed.
2.  The target suffers a traumatic mental shock, losing 1d3 Smarts dice for 1 hour.
3.  Target becomes paralyzed with fear for 1d4 turns, unable to act.
...
1.  The caster's hand warps, becoming temporarily unusable.
2.  The object or creature gains a bizarre and useless mutation.
3.  The caster is warped, shrinking or growing by a foot in height for 1 hour.

**Light Effect Table**:

1.  Minor warping—target’s skin changes color or texture.
2.  Target’s appearance subtly shifts, making them unrecognizable for 1 hour.
3.  A part of the target’s body becomes slightly mutated (e.g., a longer finger or ear).

**Heavy Effect Table**:

1.  The target’s limbs transform into a different form (tentacles, wings, etc.) for 1d4 turns.
2.  Target’s size increases or decreases significantly, gaining temporary Strength or Speed bonuses.
3.  The target is transmuted into a harmless object (e.g., a rock) for 1 turn.
...
1.  The veil obscures the caster’s vision as well as the target's.
2.  The veil backfires, confusing allies instead of enemies.
3.  The veil causes hallucinations, making the caster see enemies that aren't there.

**Light Effect Table**:

1.  Caster gains partial invisibility, imposing disadvantage on enemies' attack rolls.
2.  Caster’s location becomes difficult to pinpoint, giving enemies a 50% miss chance.
3.  A minor illusion distracts enemies, slowing their actions for 1 turn.

**Heavy Effect Table**:

1.  The caster becomes fully invisible for 1d4 turns.
2.  The space around the caster warps, preventing any physical attacks from hitting for 1 turn.
3.  Enemies see twisted, horrifying illusions and must flee or lose a turn in fear.
...
1.  Caster's skin hardens briefly, causing them to lose 1 Speed die for 1 turn.
2.  The spell backfires, making the target heavier and slower instead of stronger.
3.  The transformation is incomplete, causing patchy and brittle skin that reduces Armor.

**Light Effect Table**:

1.  Target's skin hardens, granting +1 armor for 1 turn.
2.  The target gains resistance to non-magical attacks for 1d4 turns.
3.  Target’s fists become iron-hard, allowing unarmed attacks to deal extra damage.

**Heavy Effect Table**:

1.  The target's entire body becomes metal for 1d4 turns, immune to non-magical damage.
2.  The target’s strength and durability increase, gaining +2 Armor and +1 Strength die.
3.  The target becomes a living statue, unable to act but immune to all damage for 1 turn.
...
1.  The plant grows uncontrollably, blocking the caster’s path.
2.  The plant sprouts but immediately withers.
3.  A poisonous plant appears, causing the caster to take 1 damage from toxic pollen.

**Light Effect Table**:

1.  Vines entangle the nearest target, reducing their movement for 1 turn.
2.  The plant produces harmless but beautiful flowers, distracting enemies.
3.  The plant grows rapidly, providing cover for the caster or allies.

**Heavy Effect Table**:

1.  A carnivorous plant sprouts, attacking enemies for 1d6 damage each turn for 1d4 turns.
2.  The plant releases toxic spores, dealing 1d4 poison damage to all enemies nearby.
3.  The plant bears magical fruit, which can heal an ally or harm an enemy (roll 1d6: even = heal, odd = harm).
...
1.  The mist engulfs the caster, causing them to lose track of their surroundings.
2.  The mist dissipates immediately, having no effect.
3.  The caster becomes confused and loses their next turn.

**Light Effect Table**:

1.  The mist reduces visibility, giving enemies disadvantage on ranged attacks.
2.  Enemies forget the last action they took.
3.  The mist causes mild confusion, delaying enemy actions for 1 turn.

**Heavy Effect Table**:

1.  The mist erases the memory of the last minute from all affected, resetting the fight.
2.  Enemies wander aimlessly in the mist for 1d4 turns.
3.  Everyone within the mist forgets their immediate goal and acts randomly for 1 turn.
...
1.  The caster experiences a brief time loop, repeating their last action.
2.  Time speeds up for the caster, causing them to lose their next turn.
3.  Time slows, but only for the caster, reducing their Speed by 1 die for 1 turn.

**Light Effect Table**:

1.  The caster can take an extra action this turn.
2.  Time slows down for all enemies, reducing their Speed by 1 die.
3.  A brief rewind allows the caster to undo the last 10 seconds of combat.

**Heavy Effect Table**:

1.  The caster accelerates through time, allowing them to act twice in each turn for 1d4 turns.
2.  Time freezes for everyone but the caster for 1 turn, allowing them to act freely.
3.  Time rewinds 1 minute, undoing any recent damage or actions.
...
1.  The key fails and vanishes.
2.  The lock becomes more difficult to open.
3.  The key opens the wrong door, leading to an unexpected place or danger.

**Light Effect Table**:

1.  The key unlocks a basic door or chest.
2.  The key bypasses a simple magical barrier.
3.  The key opens a hidden compartment or passage.

**Heavy Effect Table**:

1.  The key opens a portal to another dimension for 1d4 turns.
2.  The key unlocks an ancient, sealed vault or stronghold.
3.  The key dispels a powerful magical seal, revealing hidden secrets or treasures.
...
1.  The spirit refuses to answer or gives false information.
2.  The caster hears whispers but cannot understand them.
3.  A vengeful spirit is summoned instead, attacking the caster.

**Light Effect Table**:

1.  The caster speaks with a local spirit, gaining simple information.
2.  The caster receives advice from a forgotten soul.
3.  The spirit answers one question truthfully.

**Heavy Effect Table**:

1.  A powerful forgotten being offers the caster knowledge or aid.
2.  The spirit grants the caster a temporary boon, such as increased Smarts.
3.  The caster summons a long-dead hero to assist them for 1d4 turns.
...
reality, causing bizarre effects.

**Misfire Table**:

1.  The tear destabilizes, affecting the caster.
2.  The tear closes immediately, doing nothing.
3.  Reality warps in an unintended way, causing strange environmental effects.

**Light Effect Table**:

1.  A small tear causes minor shifts in reality, such as objects floating or reversing gravity briefly.
2.  Nearby objects flicker in and out of existence.
3.  A strange anomaly appears, creating unpredictable effects for 1 turn.

**Heavy Effect Table**:

1.  A large tear warps the environment, changing the battlefield significantly.
2.  Reality itself is bent, allowing the caster to alter the laws of physics temporarily.
3.  A powerful entity or force is summoned from beyond the tear, aiding or hindering the caster.

---

These spells should offer a dynamic and flexible experience for your players, with exciting effects, risks, and rewards at each roll level!
