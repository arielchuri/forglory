...
# Convert concatenated content to Markdown
markdown_output = concatenated_content
...
html_output_file_path = os.path.join(output_directory, 'output.html')

# Write the HTML output with CSS to the output file in the output directory
with open(html_output_file_path, 'w') as output_file:
    output_file.write(f'''
<!DOCTYPE html>
<html>
<head>
...
# Define the path for the output Markdown file in the output directory
markdown_output_file_path = os.path.join(output_directory, 'output.md')

# Write the Markdown output to the output file in the output directory
with open(markdown_output_file_path, 'w') as output_file:
    output_file.write(markdown_output)

print('Markdown file writing completed') # Print a message after writing the Markdown file
